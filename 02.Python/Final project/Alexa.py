...
def Alexa_notification():
    ...
    schedule.every(80).seconds.do(Alexa_notification)
...
greeting = ["am here","what's up","yeah!","what's good bro","whaaaat!","yes dear","what's good","what's happening","what's going on","what's new","what's the craic","what's the story","what's the story morning"]
...
def Responses():
    ...
    while status:
        ...
        if 'alexa' == me:
            ...
            Alexa_readFile()
        elif Search_for_words(["azan","what time is theprayer"],me):
            Alexa_Azantiming()
        elif Search_for_words(["reminder","remind me","remind"],me):
            Alexa_reminder()
        elif Search_for_words(["search wikipedia","wikipedia"],me):
            Alexa_wiki()
        else:
